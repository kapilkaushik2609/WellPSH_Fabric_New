...
const getCCP = async (org) => {
  ...
  if (org == "Org1") {
    ...
    ccpPath = path.resolve(__dirname, "..", "config", "connection-org6.json");
  } else return null;
...
const getCaUrl = async (org, ccp) => {
  ...
  if (org == "Org1") {
    ...
    caURL = ccp.certificateAuthorities["ca.org6.hiam.hal"].url;
  } else return null;
  return caURL;
};
...
const getWalletPath = async (org) => {
  ...
  if (org == "Org1") {
    ...
    walletPath = path.join(process.cwd(), "Org6-wallet");
  } else return null;
  return walletPath;
};
...
const getCaInfo = async (org, ccp) => {
  ...
  if (org == "Org1") {
    ...
    caInfo = ccp.certificateAuthorities["ca.org6.hiam.hal"];
  } else return null;
  return caInfo;
};
