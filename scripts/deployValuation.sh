...
VERSION="1"
SEQUENCE=1
CC_SRC_PATH="../artifacts/chaincode/valuationContract"
CC_NAME="valuation"
...
# Initialize Valuation contract with asset ID VAL0000
chaincodeInitLedgerValuation() {
    setGlobals 1
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:15051 --tlsRootCertFiles $PEER0_ORG5_CA   \
        --peerAddresses localhost:17051 --tlsRootCertFiles $PEER0_ORG6_CA   \
        -c '{"function": "initLedgerValuation","Args":[]}'
}
#Note for version && seuqunce > 1, dont run chaincodeInitLedgerValuation as this will reset valuation id counter
...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:15051 --tlsRootCertFiles $PEER0_ORG5_CA \
        --peerAddresses localhost:17051 --tlsRootCertFiles $PEER0_ORG6_CA \
        -c '{"function": "createValuation", "Args": ["PRJ0001", "{\"prj_id\":\"PRJ0001\", \"val_date\":\"2024-04-09\", \"val_company\":\"Valuation Co.\", \"val_time_period\":5, \"tot_asset_value\":1000000, \"exp_revenue\":1500000, \"exp_CC\":500000, \"val_doc_ref\":\"http://example.com/valuation_report.pdf\", \"tot_prj_val\":2000000}"]}'
}
...
chaincodeUpdate() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:15051 --tlsRootCertFiles $PEER0_ORG5_CA \
        --peerAddresses localhost:17051 --tlsRootCertFiles $PEER0_ORG6_CA \
        -c '{"function":"updateValuation","Args":["VAL0001","{\"tot_asset_value\":2000000, \"exp_revenue\":3000000}"]}'
}
...
chaincodeQueryGetValuationByID() {
    setGlobals 1
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "getValuation","Args":["VAL0001"]}'
}
...
chaincodeQueryGetAllValuation() {
    setGlobals 1
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "getAllValuationsForProject","Args":["PRJ0001"]}'
}
...
chaincodeQueryGetValuationHistory() {
    setGlobals 1
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "getValHistory","Args":["VAL0001"]}'
}
...
chaincodeQueryLatestValID() {
    setGlobals 1
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "getLatestValuationId","Args":[""]}'
}
