...
VERSION="1"
SEQUENCE=1
CC_SRC_PATH="../artifacts/chaincode/healthStatusContract"
CC_NAME="HealthCheckContract"
...
chaincodeInitLedger() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:15051 --tlsRootCertFiles $PEER0_ORG5_CA   \
        --peerAddresses localhost:17051 --tlsRootCertFiles $PEER0_ORG6_CA   \
        -c '{"function": "CheckNetworkStatus","Args":[]}'
}


chaincodeQueryStatus() {
    setGlobals 1
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "CheckNetworkStatus","Args":[""]}'
}
chaincodeQueryStatus
# prestup
